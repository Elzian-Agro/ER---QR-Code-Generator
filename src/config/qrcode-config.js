...
export const qrCodeConfig = {
    fields: [
        ...
        { label: "Payment Ammount", key: ["Payment Ammount,$", "AI"] },
        { label: "In SL Rupies", key: ["In SL Rupies", "AJ"] },
        { label: "Performance(2021/2)", key: ["performance  of plants/Units as at date 2021/Feb ", "AH"] },
        { label: "Payment exchange", key: ["Payment exchange $", "AL"] },
        { label: "In SL Rupies_1", key: ["In SL Rupies_1", "AM"] },
